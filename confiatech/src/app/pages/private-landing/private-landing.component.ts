...
import { faLaptopCode, faTerminal, faQrcode, faIcons, faSprayCan, faCodeMerge, faServer, faArrowsToCircle, faHandHoldingHand, faStopwatch, faComputer, faStar } from '@fortawesome/free-solid-svg-icons';
...
@Component({
  ...
  standalone: true,
  imports: [ConfiaButtonComponent, FontAwesomeModule, CommonModule, NgOptimizedImage, PortfolioCompComponent, ContactComponent],
...
export class PrivateLandingComponent {
  ...
  constructor(private meta: Meta,
    private cdr:ChangeDetectorRef, private title: Title, private route: ActivatedRoute,@Inject(PLATFORM_ID) platformId: Object,private analytics:AnalyticsService) {
    this.setMetaTags();
  ...
  ngOnInit() {
    ...
    if(this.isBrowser){
      this.analytics.trackEvent("Private page","Private page loaded into view","Devops page");
  ...
  accept(){
    document.getElementById('cookieConsent')?.classList.remove('tw-block')
