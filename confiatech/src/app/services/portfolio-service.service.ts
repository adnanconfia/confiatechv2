...
`,
          technologies: ['Angular', 'Django', 'Boostrap', 'MySQL'],
          url: '',
          images: [
...
`,
          ...
          metaDescription:
            'Explore Axis IMS, a web app for managing immigration visas and inter-office tasks with Angular, Django, and AWS for seamless efficiency.',
        },
        {
          id: 3,
...
`,
          technologies: ['Angular', 'Bootstrap', 'SQL Server', 'ASP.net'],
          url: '',
          images: [
...
`,
          technologies: ['Angular', 'Bootstrap', 'Postgres SQL', 'Django'],
