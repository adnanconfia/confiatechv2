...
import { faArrowsToCircle, faCodeMerge, faComputer, faHandHoldingHand, faIcons, faLaptopCode, faQrcode, faServer, faSprayCan, faStopwatch, faTerminal } from '@fortawesome/free-solid-svg-icons';
